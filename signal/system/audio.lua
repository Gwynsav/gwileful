-- Original from Crylia:
-- https://github.com/Crylia/crylia-theme/blob/294b15e9eae858526b4727edef033ba58c737a3b/awesome/src/tools/helpers/audio.lua
...
function audio:toggle_sink_mute()
  if not self.allow_cmd then return end
  self.allow_cmd = false
...
function audio:toggle_source_mute()
  if not self.allow_cmd then return end
  self.allow_cmd = false
